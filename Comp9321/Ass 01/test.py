...
def question_3(t1):
    ...
    df1 = read_csv(csv_file)
    # Your code goes here ...
    replace_str = 'Bus, Ferry, Light Rail, Train, Metro'
    # Lower all the case ! 
    ...
    df3 = df1.copy()
    #################################################
    #print (df3.transport_name.unique())
...
if __name__ == "__main__":
    df1 = question_1('route.csv', 'suburbs.csv')
    df2 = question_2(df1)
    # df3 = question_3('routes.csv')
    # df4 = question_4(df3)
    # df5 = question_5(df3,'suburbs.csv')
